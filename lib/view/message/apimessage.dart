...
class ApiMessagesScreen extends StatefulWidget {
  const ApiMessagesScreen({Key? key}) : super(key: key);

  @override
  State<ApiMessagesScreen> createState() => _MessagesScreenState();
}

class _MessagesScreenState extends State<ApiMessagesScreen> {
  ...
  builder: (context, messageProvider, child) {
    ...
    : null,
               ...
               title: Text(contact.name.isNotEmpty ? contact.name : 'Unnamed'),
