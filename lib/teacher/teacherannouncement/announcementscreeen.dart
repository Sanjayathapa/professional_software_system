...
class TeacherNotificationManagement extends StatefulWidget {
  const TeacherNotificationManagement({Key? key}) : super(key: key);

  @override
  State<TeacherNotificationManagement> createState() =>
      _AdminNotificationManagementState();
}

class _AdminNotificationManagementState
    extends State<TeacherNotificationManagement> {
  void initState() {
    super.initState();
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (_) => TeacherNotificationScreen()));
        },
